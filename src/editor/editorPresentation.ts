...
const contextualFieldKeys: Readonly<Record<string, string>> = {
  ...
  "choice-source.max": "sourceMaximum",
  "jump.discount-stacking": "discountStacking",
  "jump.discount-floor": "discountFloor",
  "discount.mode": "discountMode",
  "discount.group": "discountGroup",
  "discount.amount": "discountAmount",
  "discount.resource": "discountResource",
...
const contextualHelpKeys: Readonly<Record<string, string>> = {
  ...
  "choice-source.resolution": "resolution",
  "choice-source.max": "sourceMaximum",
  "choice.lock": "sectionEffect",
  "choice.unlock": "sectionEffect",
  "input.selection": "inputSelection",
  "input.placeholder": "placeholder",
  "input.min": "minimum",
  "input.max": "maximum",
  ...
  "discount.amount": "discountAmount",
  "discount.resource": "discountResource",
  "rule.orientation": "ruleOrientation",
  "grant.kind": "grantKind",
